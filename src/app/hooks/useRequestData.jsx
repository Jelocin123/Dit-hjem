  ...
  const makeRequest = async ( url, headers = null, params = null, method = "GET", bodydata = null ) => {
    ...
    try {
      ...
      if(method === "GET") {
        ...
        response = await axios.put( url, bodydata, { headers: headers, params: params, withCredentials: true })

      } else if (method === "PATCH") {

        response = await axios.patch( url, bodydata, { headers: headers, params: params, withCredentials: true })
